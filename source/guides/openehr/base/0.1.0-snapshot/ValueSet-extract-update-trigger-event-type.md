...
## ValueSet: Extract Update Trigger Event Type 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://specifications.openehr.org/fhir/valueset-extract_update_trigger_event_type | *Version*:0.1.0-snapshot | |
...
```json
{
  ...
  "url" : "https://specifications.openehr.org/fhir/valueset-extract_update_trigger_event_type",
  ...
  "compose" : {
    ...
    "include" : [
      {
        "system" : "https://specifications.openehr.org/fhir/codesystem-extract_update_trigger_event_type",
        "version" : "3.1.0"
      }
    ]
  }
