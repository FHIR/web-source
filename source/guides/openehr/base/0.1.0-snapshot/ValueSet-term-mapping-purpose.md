...
## ValueSet: Term Mapping Purpose 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://specifications.openehr.org/fhir/valueset-term_mapping_purpose | *Version*:0.1.0-snapshot | |
...
```json
{
  ...
  "url" : "https://specifications.openehr.org/fhir/valueset-term_mapping_purpose",
  ...
  "compose" : {
    ...
    "include" : [
      {
        "system" : "https://specifications.openehr.org/fhir/codesystem-term_mapping_purpose",
        "version" : "3.1.0"
      }
    ]
  }
