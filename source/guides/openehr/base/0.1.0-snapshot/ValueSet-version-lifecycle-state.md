...
## ValueSet: Version Lifecycle State 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://specifications.openehr.org/fhir/valueset-version_lifecycle_state | *Version*:0.1.0-snapshot | |
...
```json
{
  ...
  "url" : "https://specifications.openehr.org/fhir/valueset-version_lifecycle_state",
  ...
  "compose" : {
    ...
    "include" : [
      {
        "system" : "https://specifications.openehr.org/fhir/codesystem-version_lifecycle_state",
        "version" : "3.1.0"
      }
    ]
  }
