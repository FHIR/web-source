...
* [**DV_DATE_TIME**](StructureDefinition-DV-DATE-TIME.md)
* **OperationDefinition**
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://openehr.org/fhir/StructureDefinition/DV-DATE-TIME#is_strictly_comparable_to | *Version*:0.1.0-snapshot | |
