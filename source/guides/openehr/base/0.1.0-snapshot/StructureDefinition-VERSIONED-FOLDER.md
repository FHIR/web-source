# VERSIONED_FOLDER - OpenEHR Base package v0.1.0-snapshot

* [**Home Page**](index.md)
* [**Artifacts Summary**](artifacts.md)
* **VERSIONED_FOLDER**

## Logical Model: VERSIONED_FOLDER 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://openehr.org/fhir/StructureDefinition/VERSIONED-FOLDER | *Version*:0.1.0-snapshot | |
| *Standards status:*[Informative](http://hl7.org/fhir/R5/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 3 | *Computable Name*:VERSIONED_FOLDER |

 
A version-controlled hierarchy of`FOLDERs`giving the effect of a directory. 

**Original Source:** [specifications.openehr.org](https://specifications.openehr.org/releases/RM/development/common.html#_versioned_folder_class)

**Usages:**

* This Logical Model is not used by any profiles in this Implementation Guide

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/openehr.base|current/StructureDefinition/VERSIONED-FOLDER)
...
Other representations of profile: [CSV](StructureDefinition-VERSIONED-FOLDER.csv), [Excel](StructureDefinition-VERSIONED-FOLDER.xlsx) 
