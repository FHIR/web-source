...
## ValueSet: Integrity check algorithms 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://specifications.openehr.org/fhir/valueset-integrity_check_algorithms | *Version*:0.1.0-snapshot | |
...
* [DV_MULTIMEDIA](StructureDefinition-DV-MULTIMEDIA.md)
...
```json
{
  ...
  "url" : "https://specifications.openehr.org/fhir/valueset-integrity_check_algorithms",
  ...
  "compose" : {
    "include" : [
      {
        "system" : "https://specifications.openehr.org/fhir/codesystem-integrity_check_algorithms"
      }
    ]
  }
}
