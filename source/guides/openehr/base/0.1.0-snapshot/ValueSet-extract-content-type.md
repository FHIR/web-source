...
## ValueSet: Extract Content Type 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://specifications.openehr.org/fhir/valueset-extract_content_type | *Version*:0.1.0-snapshot | |
...
```json
{
  ...
  "url" : "https://specifications.openehr.org/fhir/valueset-extract_content_type",
  ...
  "compose" : {
    ...
    "include" : [
      {
        "system" : "https://specifications.openehr.org/fhir/codesystem-extract_content_type",
        "version" : "3.1.0"
      }
    ]
  }
