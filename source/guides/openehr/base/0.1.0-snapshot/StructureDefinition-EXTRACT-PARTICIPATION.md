# EXTRACT_PARTICIPATION - OpenEHR Base package v0.1.0-snapshot
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://openehr.org/fhir/StructureDefinition/EXTRACT-PARTICIPATION | *Version*:0.1.0-snapshot | |
| *Standards status:*[Informative](http://hl7.org/fhir/R5/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 3 | *Computable Name*:EXTRACT_PARTICIPATION |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/openehr.base|current/StructureDefinition/EXTRACT-PARTICIPATION)
...
Other representations of profile: [CSV](StructureDefinition-EXTRACT-PARTICIPATION.csv), [Excel](StructureDefinition-EXTRACT-PARTICIPATION.xlsx) 
...
```json
{
  ...
  "url" : "http://openehr.org/fhir/StructureDefinition/EXTRACT-PARTICIPATION",
        ...
        "constraint" : [
          {
            ...
            "expression" : "function.exists() and then function.generating_type.is_equal (“DV_CODED_TEXT”) implies terminology (Terminology_id_openehr).has_code_for_group_id (Group_id_participation_function, function.defining_code)"
          },
          {
            "key" : "Mode_valid",
            "severity" : "error",
