...
## ValueSet: Compression algorithms 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://specifications.openehr.org/fhir/valueset-compression_algorithms | *Version*:0.1.0-snapshot | |
...
```json
{
  ...
  "url" : "https://specifications.openehr.org/fhir/valueset-compression_algorithms",
  ...
  "compose" : {
    "include" : [
      {
        "system" : "https://specifications.openehr.org/fhir/codesystem-compression_algorithms"
      }
    ]
  }
}
