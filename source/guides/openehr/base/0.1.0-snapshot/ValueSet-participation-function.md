...
## ValueSet: Participation Function 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://specifications.openehr.org/fhir/valueset-participation_function | *Version*:0.1.0-snapshot | |
...
```json
{
  ...
  "url" : "https://specifications.openehr.org/fhir/valueset-participation_function",
  ...
  "compose" : {
    ...
    "include" : [
      {
        "system" : "https://specifications.openehr.org/fhir/codesystem-participation_function",
        "version" : "3.1.0"
      }
    ]
  }
