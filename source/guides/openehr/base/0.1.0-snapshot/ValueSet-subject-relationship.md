...
## ValueSet: Subject Relationship 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://specifications.openehr.org/fhir/valueset-subject_relationship | *Version*:0.1.0-snapshot | |
...
```json
{
  ...
  "url" : "https://specifications.openehr.org/fhir/valueset-subject_relationship",
  ...
  "compose" : {
    ...
    "include" : [
      {
        "system" : "https://specifications.openehr.org/fhir/codesystem-subject_relationship",
        "version" : "3.1.0"
      }
    ]
  }
