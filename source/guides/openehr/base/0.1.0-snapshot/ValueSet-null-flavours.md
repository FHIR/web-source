...
## ValueSet: Null Flavours 

| | | |
| :--- | :--- | :--- |
| *Official URL*:https://specifications.openehr.org/fhir/valueset-null_flavours | *Version*:0.1.0-snapshot | |
...
```json
{
  ...
  "url" : "https://specifications.openehr.org/fhir/valueset-null_flavours",
  ...
  "compose" : {
    ...
    "include" : [
      {
        "system" : "https://specifications.openehr.org/fhir/codesystem-null_flavours",
        "version" : "3.1.0"
      }
    ]
  }
