# Pain treatment plan - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/pain-treatment-plan | *Version*:2022.1.1 |
| Active as of 2026-06-04 | *Computable Name*:PAIN_TREATMENT_PLAN |
| *Other Identifiers:*OID:2.16.840.1.114222.48.35 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.35"
  }],
  "version" : "2022.1.1",
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-06-04T10:30:58-06:00",
