# Hospice Disposition - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/hospice-disposition | *Version*:2022.1.1 |
| Active as of 2023-05-25 | *Computable Name*:HOSPICE_DISPOSITION |
| *Other Identifiers:*OID:2.16.840.1.114222.48.48 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.48"
  }],
  "version" : "2022.1.1",
  ...
  "expansion" : {
    "identifier" : "urn:uuid:6423310a-9e35-4f18-a2ed-2acb9166e5eb",
