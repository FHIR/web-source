# Oxycodone Medications - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/oxycodone-medications | *Version*:2022.1.1 |
| Active as of 2025-02-24 | *Computable Name*:OXYCODONE_MEDICATIONS |
| *Other Identifiers:*OID:2.16.840.1.113883.4.642.40.65.48.66 | |
...
Step 2 Create Batch text input file (Ingredients.txt) with following RxNorm Oxycodone as an input within the file: 7804
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.113883.4.642.40.65.48.66"
  }],
  "version" : "2022.1.1",
  ...
  "copyright" : "© CDC 2016+.",
  "expansion" : {
    "identifier" : "urn:uuid:3583617a-713f-45ae-81f3-71d02832c71b",
