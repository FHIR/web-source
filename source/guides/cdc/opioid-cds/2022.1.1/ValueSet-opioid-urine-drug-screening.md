# Opioid drug urine screening - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/opioid-urine-drug-screening | *Version*:2022.1.1 |
| Active as of 2026-06-03 | *Computable Name*:OPIOID_URINE_DRUG_SCREENING |
| *Other Identifiers:*OID:2.16.840.1.113883.4.642.40.65.48.65 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.113883.4.642.40.65.48.65"
  }],
  "version" : "2022.1.1",
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-06-03T10:16:59-06:00",
