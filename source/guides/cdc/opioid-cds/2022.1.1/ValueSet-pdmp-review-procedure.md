# PDMP review procedure - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/pdmp-review-procedure | *Version*:2022.1.1 |
| Active as of 2023-05-25 | *Computable Name*:PDMP_REVIEW_PROCEDURE |
| *Other Identifiers:*OID:2.16.840.1.114222.48.37 | |
...
A procedure to review the prescription drug monitoring program data 
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.37"
  }],
  "version" : "2022.1.1",
