# Non-opioid drug urine screening - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/non-opioid-urine-drug-screening | *Version*:2022.1.1 |
| Active as of 2026-06-03 | *Computable Name*:NON_OPIOID_URINE_DRUG_SCREENING |
| *Other Identifiers:*OID:2.16.840.1.113883.4.642.40.65.48.64 | |
...
* Included into [All urine drug screening tests](ValueSet-all-urine-drug-screening-tests.md)
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.113883.4.642.40.65.48.64"
  }],
  "version" : "2022.1.1",
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-06-03T11:16:38-06:00",
