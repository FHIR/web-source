# Xylazine drug urine screening tests - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/xylazine-urine-drug-screening-tests | *Version*:2022.1.1 |
| Active as of 2026-06-02 | *Computable Name*:XYLAZINE_URINE_DRUG_SCREENING_TESTS |
| *Other Identifiers:*OID:2.16.840.1.113883.4.642.40.65.48.69 | |
...
```json
{
  ...
  },
  {
    ...
    {
      "url" : "text",
      "valueMarkdown" : "Maintenance search expression: `multiaxial_descendantsof:(LP437281-1 OR LP435271-4) AND system:urine`. The compose anchors at two trunk LP codes - LP437281-1 and LP435271-4 - using `concept is-a` filters scoped to SYSTEM=LP7681-2 (urine) and CLASSTYPE=1 (lab test). To regenerate: re-run the search expression as a LOINC hierarchy query, add any newly-discovered trunk LP code as another is-a filter, then re-expand."
    }],
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.113883.4.642.40.65.48.69"
  }],
  "version" : "2022.1.1",
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-06-02T10:00:16-06:00",
