# Condition Clinical Status Active - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/condition-clinical-status-active | *Version*:2022.1.1 |
| Active as of 2023-05-25 | *Computable Name*:CONDITION_CLINICAL_STATUS_ACTIVE |
| *Other Identifiers:*OID:2.16.840.1.114222.48.44 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.44"
  }],
  "version" : "2022.1.1",
  ...
  "expansion" : {
    "identifier" : "urn:uuid:28f493d2-d286-4d76-a272-7a78f1fcb5ed",
