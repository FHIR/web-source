# CDC malignant cancer conditions - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/cdc-malignant-cancer-conditions | *Version*:2022.1.1 |
| Active as of 2026-04-30 | *Computable Name*:CDC_MALIGNANT_CANCER_CONDITIONS |
| *Other Identifiers:*OID:2.16.840.1.114222.48.7 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.7"
  }],
  "version" : "2022.1.1",
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-04-30T13:28:46-06:00",
