# Extended release opioid with ambulatory misuse potential - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/extended-release-opioid-with-ambulatory-misuse-potential | *Version*:2022.1.1 |
| Active as of 2025-02-24 | *Computable Name*:EXTENDED_RELEASE_OPIOID_WITH_AMBULATORY_MISUSE_POTENTIAL |
| *Other Identifiers:*OID:2.16.840.1.114222.48.13 | |
...
Step 1: Expand the value set "Opioids with Opioid analgesic with ambulatory misuse potential" and then remove concepts that are long acting:
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.13"
  }],
  "version" : "2022.1.1",
  ...
  "copyright" : "© CDC 2016+.",
  "expansion" : {
    "identifier" : "urn:uuid:6b98e556-7011-4dbf-89e9-92308c6e485f",
