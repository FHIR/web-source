# FHIRModelInfo - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| *Other Identifiers:*http://example.org/fhir/cqi/ecqm/Library/Identifier#FHIR (use: official, ), OID:2.16.840.1.114222.28.3 | |
...
```json
{
  ...
  },
  {
    ...
    "value" : "urn:oid:2.16.840.1.114222.28.3"
  }],
  "version" : "4.0.1",
  "name" : "FHIR",
