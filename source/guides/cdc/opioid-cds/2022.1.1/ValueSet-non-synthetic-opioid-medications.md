# Non-synthetic opioid medications - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/non-synthetic-opioid-medications | *Version*:2022.1.1 |
| Active as of 2025-02-24 | *Computable Name*:NON_SYNTHETIC_OPIOID_MEDICATIONS |
| *Other Identifiers:*OID:2.16.840.1.114222.48.25 | |
...
Step 2 Create Batch text input file (Ingredients.txt) with following RxNorm non-synthetic opioid ingredient codes representing morphine, codeine, opium as an input within the file: 2670 7052 7676
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.25"
  }],
  "version" : "2022.1.1",
  ...
  "copyright" : "© CDC 2016+.",
  "expansion" : {
    "identifier" : "urn:uuid:50a5d2f8-d28a-4d71-b49a-6bffc0c931cc",
