# Recommendation #12 - Evidence-based Treatment for Patients with Opioid Use Disorder (patient-view) - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| *Other Identifiers:*cdc-opioid-guidance (use: official, ), OID:2.16.840.1.114222.34.15 | |
...
```json
{
  ...
  },
  {
    ...
    "value" : "urn:oid:2.16.840.1.114222.34.15"
  }],
  "version" : "2022.1.0",
