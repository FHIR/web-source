# CDC 2022 Opioid Guidance Clinical Focus Extension - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| *Other Identifiers:*OID:2.16.840.1.114222.42.3 | |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.cdc.opioid-cds|current/StructureDefinition/StructureDefinition-cdc-valueset-clinical-focus.json)
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.42.3"
  }],
  "version" : "1.0.0",
