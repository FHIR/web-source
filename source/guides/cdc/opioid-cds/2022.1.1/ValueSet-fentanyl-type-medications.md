# Fentanyl-type medications - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/fentanyl-type-medications | *Version*:2022.1.1 |
| Active as of 2025-02-24 | *Computable Name*:FENTANYL_TYPE_MEDICATIONS |
| *Other Identifiers:*OID:2.16.840.1.114222.48.14 | |
...
Step 2 Create Batch text input file (Ingredients.txt) with following RxNorm Fentanyl-type ingredient codes representing fentanyl, sufentanil, alfentanil, remifentanil as an input within the file: 4337 56795 480 73032
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.14"
  }],
  "version" : "2022.1.1",
  ...
  "copyright" : "© CDC 2016+.",
  "expansion" : {
    "identifier" : "urn:uuid:ba34299f-8cee-4c51-bd56-33a047391d5d",
