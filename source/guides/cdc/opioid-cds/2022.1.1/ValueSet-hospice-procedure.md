# Hospice Procedure - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/hospice-procedure | *Version*:2022.1.1 |
| Active as of 2023-05-25 | *Computable Name*:HOSPICE_PROCEDURE |
| *Other Identifiers:*OID:2.16.840.1.114222.48.18 | |
...
```json
{
  ...
  "extension" : [{
    ...
    "valueString" : "Procedure codes for referral, admission, or transfer to a hospice"
  },
  {
  ...
  "url" : "http://fhir.org/guides/cdc/opioid-cds/ValueSet/hospice-procedure",
  "identifier" : [{
    "system" : "urn:ietf:rfc:3986",
    "value" : "urn:oid:2.16.840.1.114222.48.18"
  }],
  "version" : "2022.1.1",
  "name" : "HOSPICE_PROCEDURE",
  "title" : "Hospice Procedure",
  "status" : "active",
  "experimental" : false,
