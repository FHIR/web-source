# CNS depressant medications - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/cns-depressant-medications | *Version*:2022.1.1 |
| Active as of 2025-02-24 | *Computable Name*:CNS_DEPRESSANT_MEDICATIONS |
| *Other Identifiers:*OID:2.16.840.1.114222.48.8 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.8"
  }],
  "version" : "2022.1.1",
  ...
  "copyright" : "© CDC 2016+.",
  "expansion" : {
    "identifier" : "urn:uuid:da467437-1606-4777-8545-d9a950df8660",
