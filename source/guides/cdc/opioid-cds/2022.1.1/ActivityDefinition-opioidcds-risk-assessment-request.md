# OpioidRiskAssessmentActivityDefinition - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| *Other Identifiers:*OID:2.16.840.1.114222.11.2 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.11.2"
  }],
  "version" : "2022.1.0",
