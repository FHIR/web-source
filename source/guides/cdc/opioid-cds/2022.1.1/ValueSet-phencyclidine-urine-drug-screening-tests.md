# Phencyclidine urine drug screening tests - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/phencyclidine-urine-drug-screening-tests | *Version*:2022.1.1 |
| Active as of 2026-06-02 | *Computable Name*:PHENCYCLIDINE_URINE_DRUG_SCREENING_TESTS |
| *Other Identifiers:*OID:2.16.840.1.114222.48.38 | |
| **Copyright/Legal**: © CDC 2016+. | |

 
Urine screening tests for phencyclidine 
...
```json
{
  ...
  },
  {
    ...
    {
      "url" : "text",
      "valueMarkdown" : "Maintenance search expression: `multiaxial_descendantsof:(LP14566-1) AND system:urine`. The compose anchors at one trunk LP code - LP14566-1 - using `concept is-a` filters scoped to SYSTEM=LP7681-2 (urine) and CLASSTYPE=1 (lab test). To regenerate: re-run the search expression as a LOINC hierarchy query, add any newly-discovered trunk LP code as another is-a filter, then re-expand."
    }],
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.38"
  }],
  "version" : "2022.1.1",
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-06-02T09:57:06-06:00",
