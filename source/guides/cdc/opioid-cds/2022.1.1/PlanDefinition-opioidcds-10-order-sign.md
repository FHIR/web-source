# Recommendation #10 - Urine Drug Testing (order-sign) - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Recommendation #10 - Urine Drug Testing (order-sign)**

## PlanDefinition: Recommendation #10 - Urine Drug Testing (order-sign) 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/PlanDefinition/opioidcds-10-order-sign | *Version*:2022.1.0 |
| Active as of 2025-08-06 | *Computable Name*:PlanDefinition_Recommendation_10_Order_Sign |
| *Other Identifiers:*cdc-opioid-guidance (use: official, ), OID:2.16.840.1.114222.34.10 | |
...
* **Actions: **: **Url: **
  * : [Recommendation #10 - Urine Drug Testing (order-sign)](PlanDefinition-opioidcds-10-order-sign.md)
* **Actions: **: **Version: **
  * : 2022.1.0
* **Actions: **: **Name: **
  * : PlanDefinition_Recommendation_10_Order_Sign
* **Actions: **: **Title: **
  * : Recommendation #10 - Urine Drug Testing (order-sign)
* **Actions: **: **Status: **
  * : active
...
```json
{
  ...
  },
  {
    ...
    "value" : "urn:oid:2.16.840.1.114222.34.10"
  }],
  "version" : "2022.1.0",
  ...
  "action" : [{
    ...
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
        "description" : "Patient has not had a urine screening in the specified lookback period",
    ...
    "action" : [{
      "reason" : [{
        "coding" : [{
          "system" : "http://fhir.org/guides/cdc/opioid-cds/CodeSystem/opioidcds-overrideReasons",
          "code" : "UToxAccepted",
          "display" : "Action Taken"
        }],
        "text" : "Document - Ordered toxicology screen"
      }]
    },
    {
      "reason" : [{
        ...
        "text" : "Document - Risks outweigh benefits"
      }]
    },
    {
      "reason" : [{
        ...
        "text" : "Snooze - N/A see comment, snooze 3 months"
      }]
    },
    {
      "reason" : [{
        ...
        "text" : "Snooze - N/A see comment, snooze 1 year"
      }]
    }]
  },
  {
    ...
    "description" : "Patient may have unexpected urine toxicology test results in the specified lookback period",
    "priority" : "urgent",
    "trigger" : [{
      "type" : "named-event",
      "name" : "order-sign"
    ...
    "action" : [{
      "reason" : [{
        ...
        "text" : "Document - Will repeat urine drug screen more frequently"
      }]
    },
    {
      "reason" : [{
        ...
        "text" : "The suggestion provided by the service has been declined"
      }]
    },
    {
      "reason" : [{
        ...
        "text" : "Snooze* - N/A snooze for 1 year"
      }]
    }]
  }]
}
