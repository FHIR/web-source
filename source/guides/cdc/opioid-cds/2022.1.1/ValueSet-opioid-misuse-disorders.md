# Opioid misuse disorders - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/opioid-misuse-disorders | *Version*:2022.1.1 |
| Active as of 2023-05-25 | *Computable Name*:OPIOID_MISUSE_DISORDERS |
| *Other Identifiers:*OID:2.16.840.1.114222.48.32 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.32"
  }],
  "version" : "2022.1.1",
