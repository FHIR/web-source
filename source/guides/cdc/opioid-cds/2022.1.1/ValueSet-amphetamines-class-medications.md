# Amphetamine class medications - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/amphetamines-class-medications | *Version*:2022.1.1 |
| Active as of 2025-02-24 | *Computable Name*:AMPHETAMINES_CLASS_MEDICATIONS |
| *Other Identifiers:*OID:2.16.840.1.114222.48.3 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.3"
  }],
  "version" : "2022.1.1",
  ...
  "copyright" : "© CDC 2016+.",
  "expansion" : {
    "identifier" : "urn:uuid:0d42aa62-4c19-4f88-88f2-db0870af0d5e",
