# Recommendation #2 - Opioid Therapy Goals Discussion - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Recommendation #2 - Opioid Therapy Goals Discussion**

## PlanDefinition: Recommendation #2 - Opioid Therapy Goals Discussion 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/PlanDefinition/opioidcds-02 | *Version*:2022.1.0 |
| Active as of 2025-08-06 | *Computable Name*:PlanDefinition_Recommendation_02_Order_Sign |
| *Other Identifiers:*cdc-opioid-guidance (use: official, ), OID:2.16.840.1.114222.34.2 | |
...
* **Actions: **: **Url: **
  * : [Recommendation #2 - Opioid Therapy Goals Discussion](PlanDefinition-opioidcds-02.md)
* **Actions: **: **Version: **
  * : 2022.1.0
* **Actions: **: **Name: **
  * : PlanDefinition_Recommendation_02_Order_Sign
* **Actions: **: **Title: **
  * : Recommendation #2 - Opioid Therapy Goals Discussion
* **Actions: **: **Status: **
  * : active
...
| |
| :--- |
| [Library - Recommendation #2 - Opioid Therapy Goals Discussion](Library-OpioidCDSREC02.md) |
...
```json
{
  ...
  },
  {
    ...
    "value" : "urn:oid:2.16.840.1.114222.34.2"
  }],
  "version" : "2022.1.0",
  ...
  "action" : [{
    ...
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
        "description" : "Check whether the current order is for an opioid with ambulatory misuse potential, a pain treatment plan has been established or edited within the past 90 days, a pain management procedure occurred within the past 90 days, the patient is opioid naive and if the 2022 CDC guideline general inclusion criteria is met",
