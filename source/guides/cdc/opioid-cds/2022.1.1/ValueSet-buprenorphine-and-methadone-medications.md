# Buprenorphine and Methadone medications - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/buprenorphine-and-methadone-medications | *Version*:2022.1.1 |
| Active as of 2023-05-25 | *Computable Name*:BUPRENORPHINE_AND_METHADONE_MEDICATIONS |
| *Other Identifiers:*OID:2.16.840.1.114222.48.5 | |
...
Step 2 Create Batch text input file (Ingredients.txt) with following RxNorm Buprenorphine and Methadone as an input within the file: 1819 6813
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.5"
  }],
  "version" : "2022.1.1",
  ...
  "copyright" : "© CDC 2016+.",
  "expansion" : {
    "identifier" : "urn:uuid:5a85475e-52be-4601-8038-0ad1ea93e054",
