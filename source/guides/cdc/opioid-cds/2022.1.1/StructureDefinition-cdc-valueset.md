# CDC_ValueSet - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| *Other Identifiers:*OID:2.16.840.1.114222.42.11 | |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.cdc.opioid-cds|current/StructureDefinition/StructureDefinition-cdc-valueset.json)
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.42.11"
  }],
  "version" : "0.1",
  "name" : "CDC_ValueSet",
  "status" : "draft",
