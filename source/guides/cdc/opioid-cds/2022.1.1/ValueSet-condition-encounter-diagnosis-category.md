# Encounter Diagnosis Condition Category - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/condition-encounter-diagnosis-category | *Version*:2022.1.1 |
| Active as of 2023-05-25 | *Computable Name*:ENCOUNTER_DIAGNOSIS_CONDITION_CATEGORY |
| *Other Identifiers:*OID:2.16.840.1.114222.48.45 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.45"
  }],
  "version" : "2022.1.1",
  ...
  "expansion" : {
    "identifier" : "urn:uuid:e5900d4c-a0c8-42f1-a56a-96889608af52",
