# CDC 2022 Opioid Guidance Data Element Extension - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **CDC 2022 Opioid Guidance Data Element Extension**

## Extension: CDC 2022 Opioid Guidance Data Element Extension 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/StructureDefinition/cdc-valueset-dataelement-scope | *Version*:1.0.0 |
| Draft as of 2018-04-22 | *Computable Name*:CDC_Opioid_Guidance_ValueSet_Dataelement_Scope_Extension |
| *Other Identifiers:*OID:2.16.840.1.114222.42.4 | |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/fhir.cdc.opioid-cds|current/StructureDefinition/StructureDefinition-cdc-valueset-dataelement-scope.json)
...
Other representations of profile: [CSV](StructureDefinition-cdc-valueset-dataelement-scope.csv), [Excel](StructureDefinition-cdc-valueset-dataelement-scope.xlsx), [Schematron](StructureDefinition-cdc-valueset-dataelement-scope.sch) 
...
```json
{
  ...
  "id" : "cdc-valueset-dataelement-scope",
  "url" : "http://fhir.org/guides/cdc/opioid-cds/StructureDefinition/cdc-valueset-dataelement-scope",
  "identifier" : [{
    "system" : "urn:ietf:rfc:3986",
    "value" : "urn:oid:2.16.840.1.114222.42.4"
  }],
  "version" : "1.0.0",
  "name" : "CDC_Opioid_Guidance_ValueSet_Dataelement_Scope_Extension",
  "title" : "CDC 2022 Opioid Guidance Data Element Extension",
  "status" : "draft",
  "date" : "2018-04-22",
  ...
  "differential" : {
    "element" : [{
      "id" : "Extension",
      "path" : "Extension",
      "short" : "CDC 2022 Opioid Guidance Data Element Extension",
      "definition" : "Describes the data element scope for the ValueSet.",
      "min" : 0,
      "max" : "1",
      "isModifier" : false
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://fhir.org/guides/cdc/opioid-cds/StructureDefinition/cdc-valueset-dataelement-scope"
    },
    {
