# Recommendation #11 - Concurrent Use of Opioids and Benzodiazepines (patient-view) - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Recommendation #11 - Concurrent Use of Opioids and Benzodiazepines (patient-view)**

## PlanDefinition: Recommendation #11 - Concurrent Use of Opioids and Benzodiazepines (patient-view) 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/PlanDefinition/opioidcds-11-patient-view | *Version*:2022.1.0 |
| Active as of 2025-08-06 | *Computable Name*:PlanDefinition_Recommendation_11_Patient_View |
| *Other Identifiers:*cdc-opioid-guidance (use: official, ), OID:2.16.840.1.114222.34.13 | |
...
* **Actions: **: **Url: **
  * : [Recommendation #11 - Concurrent Use of Opioids and Benzodiazepines (patient-view)](PlanDefinition-opioidcds-11-patient-view.md)
* **Actions: **: **Version: **
  * : 2022.1.0
* **Actions: **: **Name: **
  * : PlanDefinition_Recommendation_11_Patient_View
* **Actions: **: **Title: **
  * : Recommendation #11 - Concurrent Use of Opioids and Benzodiazepines (patient-view)
* **Actions: **: **Status: **
  * : active
...
| |
| :--- |
| [Library - Recommendation #11 Patient View - Concurrent Use of Opioids and Benzodiazepines](Library-OpioidCDSREC11PatientView.md) |
...
```json
{
  ...
  },
  {
    ...
    "value" : "urn:oid:2.16.840.1.114222.34.13"
  }],
  "version" : "2022.1.0",
  ...
  "action" : [{
    ...
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
        "description" : "Check whether the patient is using opioids concurrently with benzodiazepines or other central nervous system depressants and if the 2022 CDC guideline general inclusion criteria is met.",
