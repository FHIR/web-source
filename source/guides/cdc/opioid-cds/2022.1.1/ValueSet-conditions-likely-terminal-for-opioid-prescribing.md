# Conditions likely terminal for opioid prescribing - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/conditions-likely-terminal-for-opioid-prescribing | *Version*:2022.1.1 |
| Active as of 2026-06-15 | *Computable Name*:CONDITIONS_LIKELY_TERMINAL_FOR_OPIOID_PRESCRIBING |
| *Other Identifiers:*OID:2.16.840.1.114222.48.12 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.12"
  }],
  "version" : "2022.1.1",
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-06-15T12:57:51-06:00",
