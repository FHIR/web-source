# Synthetic opioid medications - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Synthetic opioid medications**

## ValueSet: Synthetic opioid medications 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/synthetic-opioid-medications | *Version*:2022.1.1 |
| Active as of 2023-05-25 | *Computable Name*:SYNTHETIC_OPIOID_MEDICATIONS |
| *Other Identifiers:*OID:2.16.840.1.114222.48.41 | |
...
Step 2a To remove all non-synthetic opioid codes filter out all codes with the following strings:: Ingredient strings: codeine, morphine, opium
...
```json
{
  ...
  "extension" : [{
    ...
    "valueString" : "All synthetic opioid clinical drugs except cough medications, antispasmodics, or those restricted to surgical use only."
  },
  {
  ...
  },
  {
    ...
    "valueString" : "All opioid-class medications not exclusively and solely derived from the opium plant"
  },
  {
    "url" : "http://fhir.org/guides/cdc/opioid-cds/StructureDefinition/cdc-valueset-exclusion-criteria",
    "valueString" : "All medications including ingredients intended to treat cough or act as an antispasmodic. All injectable forms. All medications including codeine, morphine and opium."
  },
  {
  ...
  },
  {
    ...
    "valueMarkdown" : "https://mor.nlm.nih.gov/RxMix/ Script:\r\nStep 1a \r\nCreate Batch text input file (SCT-Synthetic-Opioids.txt) with following SCT identifier (for the concept \"Product containing opioid receptor agonist (product)\") as an input within the file: \r\n360204007       \r\n\r\nStep 1b\r\nSubmit batch job using the above SCT-Synthetic-Opioids.txt file to following workflow by uploading file (SCT-Synthetic-Opioid-wf.config) with the following in the file:  <WFE><filteredOutputs>RXCUI|name|term_type</filteredOutputs><input>NOINPUT</input><FS><service>NOINPUT</service><function>findClassById</function><level>0</level><paramSize>1</paramSize><param order ='0'>?</param></FS><FS><service>NOINPUT</service><function>getClassMembers</function><level>1</level><paramSize>5</paramSize><param order ='0'>?</param><param order ='1'>SNOMEDCT</param><param order ='2'>isa_disposition</param><param order ='3'>0</param><param order ='4'>IN,MIN,PIN</param></FS><FS><service>NOINPUT</service><function>getRelatedByType</function><level>2</level><paramSize>2</paramSize><param order ='0'>?</param><param order ='1'>BPCK,GPCK,SBD,SCD</param></FS></WFE>\r\nThis will produce a result file with all Opioid clinical drugs included\r\n\r\nStep 2\r\nTo remove all cough and bowel transit formulation codes and to remove the injectable codes filter out all codes with the following strings:\r\nIngredient strings: \r\nGuaifenesin, Chlorpheniramine, Pseudoephedrine, Brompheniramine, Phenylephrine, Phenylpropanolamine, Promethazine, Bromodiphenhydramine, guaiacolsulfonate, homatropine\r\nForm strings:\r\ninject, cartridge, syringe\r\n\r\nStep 2a\r\nTo remove all non-synthetic opioid codes filter out all codes with the following strings::\r\nIngredient strings: \r\ncodeine, morphine, opium"
  }],
  "url" : "http://fhir.org/guides/cdc/opioid-cds/ValueSet/synthetic-opioid-medications",
  "identifier" : [{
    "system" : "urn:ietf:rfc:3986",
    "value" : "urn:oid:2.16.840.1.114222.48.41"
  }],
  "version" : "2022.1.1",
  "name" : "SYNTHETIC_OPIOID_MEDICATIONS",
  "title" : "Synthetic opioid medications",
  "status" : "active",
  "experimental" : false,
  ...
  "copyright" : "© CDC 2016+.",
  "expansion" : {
    "identifier" : "urn:uuid:0d39926f-abb3-4e3d-873f-decf85e226c6",
    ...
    },
    {
      "system" : "http://www.nlm.nih.gov/research/umls/rxnorm",
      "code" : "583490",
      "display" : "72 HR fentanyl 0.012 MG/HR Transdermal System [Duragesic]"
    },
    {
      "system" : "http://www.nlm.nih.gov/research/umls/rxnorm",
      "code" : "261184",
      "display" : "72 HR fentanyl 0.025 MG/HR Transdermal System [Duragesic]"
    },
    {
      "system" : "http://www.nlm.nih.gov/research/umls/rxnorm",
      "code" : "261185",
      "display" : "72 HR fentanyl 0.05 MG/HR Transdermal System [Duragesic]"
    },
    {
      "system" : "http://www.nlm.nih.gov/research/umls/rxnorm",
      "code" : "261186",
      "display" : "72 HR fentanyl 0.075 MG/HR Transdermal System [Duragesic]"
    },
    {
      "system" : "http://www.nlm.nih.gov/research/umls/rxnorm",
      "code" : "262071",
      "display" : "72 HR fentanyl 0.1 MG/HR Transdermal System [Duragesic]"
    },
    {
      "system" : "http://www.nlm.nih.gov/research/umls/rxnorm",
      "code" : "1666837",
    ...
    },
    {
      "system" : "http://www.nlm.nih.gov/research/umls/rxnorm",
      "code" : "1492671",
      "display" : "acetaminophen 325 MG / hydrocodone bitartrate 10 MG Oral Tablet [Lorcet]"
    },
    {
      "system" : "http://www.nlm.nih.gov/research/umls/rxnorm",
      "code" : "1495472",
    ...
    },
    {
      "system" : "http://www.nlm.nih.gov/research/umls/rxnorm",
      "code" : "1492675",
      "display" : "acetaminophen 325 MG / hydrocodone bitartrate 7.5 MG Oral Tablet [Lorcet]"
    },
    {
      "system" : "http://www.nlm.nih.gov/research/umls/rxnorm",
      "code" : "1495476",
    ...
    },
    {
      "system" : "http://www.nlm.nih.gov/research/umls/rxnorm",
      "code" : "977943",
      "display" : "oxymorphone hydrochloride 10 MG Oral Tablet [Opana]"
    },
    {
      "system" : "http://www.nlm.nih.gov/research/umls/rxnorm",
      "code" : "977874",
