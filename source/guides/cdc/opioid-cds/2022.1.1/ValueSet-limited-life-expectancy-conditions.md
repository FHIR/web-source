# Limited life expectancy conditions - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/limited-life-expectancy-conditions | *Version*:2022.1.1 |
| Active as of 2023-05-25 | *Computable Name*:LIMITED_LIFE_EXPECTANCY_CONDITIONS |
| *Other Identifiers:*OID:2.16.840.1.114222.48.19 | |
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.19"
  }],
  "version" : "2022.1.1",
