# Recommendation #8 - Naloxone Consideration - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Recommendation #8 - Naloxone Consideration**

## PlanDefinition: Recommendation #8 - Naloxone Consideration 

| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/PlanDefinition/opioidcds-08 | *Version*:2022.1.0 |
| Active as of 2025-08-06 | *Computable Name*:PlanDefinition_Recommendation_08_Order_Sign |
| *Other Identifiers:*cdc-opioid-guidance (use: official, ), OID:2.16.840.1.114222.34.8 | |
...
* **Actions: **: **Url: **
  * : [Recommendation #8 - Naloxone Consideration](PlanDefinition-opioidcds-08.md)
* **Actions: **: **Version: **
  * : 2022.1.0
* **Actions: **: **Name: **
  * : PlanDefinition_Recommendation_08_Order_Sign
* **Actions: **: **Title: **
  * : Recommendation #8 - Naloxone Consideration
* **Actions: **: **Status: **
  * : active
...
```json
{
  ...
  },
  {
    ...
    "value" : "urn:oid:2.16.840.1.114222.34.8"
  }],
  "version" : "2022.1.0",
  "name" : "PlanDefinition_Recommendation_08_Order_Sign",
  ...
  "usage" : "Clinicians should offer naloxone when prescribing opioids.",
  "copyright" : "© CDC 2016+.",
  "topic" : [{
  ...
  "library" : ["http://fhir.org/guides/cdc/opioid-cds/Library/OpioidCDSREC08"],
  "action" : [{
    "extension" : [{
    ...
    "condition" : [{
      "kind" : "applicability",
      "expression" : {
        "description" : "Check whether the current order is for an opioid with ambulatory misuse potential and the 2022 CDC guideline inclusion criteria is met.",
    ...
    "action" : [{
      "description" : "Order - Naloxone ordered"
    },
    {
      "description" : "Document - Verified patient is on Naloxone an has been educated on use, snooze 3 months"
    },
    {
      "description" : "Document - Naloxone discussed but declined, snooze 3 months"
    },
    {
