# Opiate specific urine drug screening tests - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/opiate-specific-urine-drug-screening-tests | *Version*:2022.1.1 |
| Active as of 2026-05-01 | *Computable Name*:OPIATE_SPECIFIC_URINE_DRUG_SCREENING_TESTS |
| *Other Identifiers:*OID:2.16.840.1.114222.48.27 | |
...
```json
{
  ...
  },
  {
    ...
    {
      "url" : "text",
      "valueMarkdown" : "Maintenance search expression: `(morphine AND NOT diamorphine AND NOT 6-Monoacetylmorphine) (=system:Urine)`. The compose anchors at two trunk LP codes - LP16093-4 and LP15174-3 - using `concept is-a` filters scoped to SYSTEM=LP7681-2 (urine) and CLASSTYPE=1 (lab test). To regenerate: re-run the search expression as a LOINC hierarchy query, add any newly-discovered trunk LP code as another is-a filter, then re-expand."
    }],
  ...
  "identifier" : [{
    ...
    "value" : "urn:oid:2.16.840.1.114222.48.27"
  }],
  "version" : "2022.1.1",
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-05-01T10:41:28-06:00",
