# Artifacts Summary - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.1
...
| [Barbiturate urine drug screening tests](ValueSet-barbiturate-urine-drug-screening-tests.md) | Presumed general urine tests for barbiturates screening and any substance that is in the class. |
| [Benzodiazepine medications](ValueSet-benzodiazepine-medications.md) | All benzodiazepine clinical drugs |
| [Benzodiazepine urine drug screening tests](ValueSet-benzodiazepine-urine-drug-screening-tests.md) | Presumed general urine tests for benzodiazepines screening and any substance that is in the class. |
...
| [Buprenorphine urine drug screening tests](ValueSet-buprenorphine-urine-drug-screening-tests.md) | Presumed general urine tests for buprenorphine screening. |
...
| [Cocaine urine drug screening tests](ValueSet-cocaine-urine-drug-screening-tests.md) | Urine screening tests for cocaine and cocaine metabolites |
...
| [Fentanyl-type urine drug screening tests](ValueSet-fentanyl-type-urine-drug-screening-tests.md) | Urine screening tests for fentanyl-type drugs and metabolites |
...
| [Heroin urine drug screening tests](ValueSet-heroin-urine-drug-screening-tests.md) | Presumed general urine screening tests for heroin and metabolites. |
...
| [Oxycodone urine drug screening tests](ValueSet-oxycodone-urine-drug-screening-tests.md) | Presumed general urine screening tests for oxycodone. |
...
| [Phencyclidine urine drug screening tests](ValueSet-phencyclidine-urine-drug-screening-tests.md) | Urine screening tests for phencyclidine |
