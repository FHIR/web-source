# Observation Category Laboratory - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.org/guides/cdc/opioid-cds/ValueSet/observation-category-laboratory | *Version*:2022.1.0 |
| Active as of 2023-05-25 | *Computable Name*:OBSERVATION_CATEGORY_LABORATORY |
...
```json
{
  ...
  "version" : "2022.1.0",
  "name" : "OBSERVATION_CATEGORY_LABORATORY",
  "title" : "Observation Category Laboratory",
  "status" : "active",
  "experimental" : false,
