# Oncology specialty designations (NUCC) - 2022 CDC Clinical Practice Guideline for Prescribing Opioids Implementation Guide v2022.1.0
...
```json
{
  ...
  "title" : "Oncology specialty designations (NUCC)",
  "status" : "active",
  "experimental" : false,
  ...
  "purpose" : "Provider types used to identify cancer care related encounters",
  "copyright" : "© CDC 2016+.",
  "compose" : {
    "include" : [{
