...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.org/guides/hrsa/uds-plus/StructureDefinition/uds-plus-sex-extension']) &lt;= 1">extension with URL = 'http://fhir.org/guides/hrsa/uds-plus/StructureDefinition/uds-plus-sex-extension': maximum cardinality of 'extension' is 1</sch:assert>
